...
static const keymap_t keys[] = {
  ...
  // My settings
	{ ControlMask, XK_i,     g_zoom,            +1        },
	{ ControlMask, XK_o,     g_zoom,            -1        },
	{ ControlMask, XK_minus, i_set_zoom,        100       },
	{ 0,           XK_j,     i_navigate_frame,  +1        },
	{ 0,           XK_k,     i_navigate_frame,  -1        },
	{ 0,           XK_j,     i_navigate,        +1        },
	{ 0,           XK_k,     i_navigate,        -1        },
	{ 0,           XK_J,     g_navigate_marked, +1        },
	{ 0,           XK_K,     g_navigate_marked, -1        },
	{ 0,           XK_h,     t_move_sel,        DIR_LEFT  },
	{ 0,           XK_l,     t_move_sel,        DIR_RIGHT },
	{ 0,           XK_j,     t_move_sel,        DIR_DOWN  },
	{ 0,           XK_k,     t_move_sel,        DIR_UP    },
	...
	{ ControlMask, XK_m,     g_switch_mode,     None      }
};
